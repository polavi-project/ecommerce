                ...
                Promise.all(promises)
                    ...
                    .catch((e) => {
                        ...
                        if(pushState === true) {
                            ...
                            if(_.get(response, "appState.currentRoute"))
                                delete response.appState.currentRoute;
                            if(_.get(response, "appState.currentRouteArgs"))
                                delete response.appState.currentRouteArgs;
                            if(_.get(response, "appState.currentUrl"))
                                delete response.appState.currentUrl;
                        }
