...
export default function CustomOption(props) {
    ...
    return <div className="product-edit-custom-option sml-block mt-4">
                ...
                return <li key={index} className="overflow-auto">
                    <table className="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>Is required?</td>
                            <td>Sort order</td>
                            <td className="align-middle"><a href="#" onClick={(e) => removeOption(index, e)} className="text-danger"><i className="fas fa-trash-alt"></i></a></td>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                    ...
                    <table className="table-bordered table">
                        ...
                        {values.map((val, i) => {
                            ...
                            return <tr key={val.value_id}>
                                ...
                                <td colSpan="3"><a href="#" onClick={(e) => removeCustomOptionValue(option_id, value_id, e)} className="text-danger"><i className="fas fa-trash-alt"></i></a></td>
                            </tr>
                        })}
                        </tbody>
                        <tfoot>
                        <tr>
                            <td colSpan="3"><a href="javascript:void(0)" onClick={(e) => addCustomOptionValue(option_id, e)}><i className="fas fa-plus"></i></a></td>
                        </tr>
                        </tfoot>
                    </table>
                </li>;
        ...
        <div><a href="#" onClick={(e) => addOption(e)}><i className="fas fa-plus"></i> <span className="pl-1">Add option</span></a></div>
    </div>;
}