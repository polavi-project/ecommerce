...
function Pending({status, noOuter = false}) {
    if(noOuter === true)
        ...
        return <span className="badge badge-secondary"><span uk-icon="icon: tag; ratio: 0.8"></span> Pending</span>;
    else
        return null;
}
...
function Delivering({status, noOuter = false}) {
    if(noOuter === true)
        ...
        return <span className="badge badge-success"><span uk-icon="icon: tag; ratio: 0.8"></span> Delivering</span>;
    else
        return null;
}
...
function Delivered({status, noOuter = false}) {
    if(noOuter === true)
        ...
        return <span className="badge badge-success"><span uk-icon="icon: tag; ratio: 0.8"></span> Delivered</span>;
    else
        return null;
}
