...
function Ecommerce(props) {
    return <div className="col-4">
        <div className="sml-block">
            <div className="sml-block-title">E-Commerce</div>
            <Area
...
function Web(props) {
    return <div className="col-4">
        <div className="sml-block">
            <div className="sml-block-title">Web</div>
            <Area
...
export default function GeneralSettingForms(props) {
    return <Form id="general_setting_form" action={props.action} submitText={null}>
        ...
        <Area id="general_setting_form_inner" className="row" coreWidgets={[
            {
                component: General,
                props : {
                    ...props.data
