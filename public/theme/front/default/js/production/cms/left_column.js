...
export default function LeftColumn(props) {
    ...
    return React.createElement(
        ...
        widgets.length > 0 && React.createElement(
            "div",
            { className: "left-column-opener column-opener d-block d-lg-none d-xl-none" },
            React.createElement(
                "a",
                { href: "#", onClick: e => {
        ...
        React.createElement(Area, _extends({}, props, { className: open === true ? "col-12 col-md-3 left-column open" : "col-12 col-md-3 left-column" }))
    );
}