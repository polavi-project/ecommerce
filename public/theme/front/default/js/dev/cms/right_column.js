...
export default function LeftColumn(props) {
    ...
    return <React.Fragment>
        {widgets.length > 0 && <div className="right-column-opener column-opener d-block d-lg-none d-xl-none">
            <a href={"#"} onClick={(e) => {e.preventDefault(); setOpen(!open);}}><i className="fas fa-sign-in-alt"></i></a>
        </div>}
        <Area {...props} className={open === true? "col-12 col-md-3 right-column open" : "col-12 col-md-3 right-column"} />
    </React.Fragment>
}