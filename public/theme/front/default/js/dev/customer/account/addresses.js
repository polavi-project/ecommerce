...
function EditForm(props) {
    ...
    const onComplete = (response) => {
        if(_.get(response, "payload.data.createCustomerAddress.status") === true) {
            props.updateAddress(
                props.index,
                {..._.get(response, "payload.data.createCustomerAddress.address"), editing:false}
            );
        } else if(_.get(response, "payload.data.updateCustomerAddress.status") === true) {
            props.updateAddress(
                props.index,
                {..._.get(response, "payload.data.updateCustomerAddress.address"), editing:false}
            );
        }
    };
    ...
    return <Form
        ...
        />
        {props.address.customer_address_id && <Hidden name={"id"} value={props.address.customer_address_id}/>}
    </Form>
}
