...
$container[\Similik\Module\Checkout\Services\Type\ItemVariantOptionType::class] =  function() use ($container) {
    return new \Similik\Module\Checkout\Services\Type\ItemVariantOptionType($container);
};