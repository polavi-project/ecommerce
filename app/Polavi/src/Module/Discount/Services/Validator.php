...
class Validator
{
    ...
    protected function defaultValidator()
    {
        $this->addValidator('general', function ($coupon) {
            ...
            if (($coupon['start_date'] and $coupon['start_date'] > date("Y-m-d H:i:s"))
            ...
            if (isset($coupon['max_uses_time_per_customer'])
            ...
            if (!empty($conditions['customer_group'])
            ...
            if (!in_array(
                ...
                ["fixed_discount_to_specific_products", "percentage_discount_to_specific_products"]
            )) {
                return true;
            }
